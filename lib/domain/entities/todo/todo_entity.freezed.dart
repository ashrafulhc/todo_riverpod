...
abstract class $TodoEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int userId, String todo, bool completed});
}
...
class _$TodoEntityImpl implements _TodoEntity {
  const _$TodoEntityImpl(
      {this.id = 0, this.userId = 0, this.todo = '', this.completed = false});
  ...
  @override
  String toString() {
    return 'TodoEntity(id: $id, userId: $userId, todo: $todo, completed: $completed)';
  }
...
abstract class _TodoEntity implements TodoEntity {
  const factory _TodoEntity(
      ...
      final int userId,
      final String todo,
      final bool completed}) = _$TodoEntityImpl;
